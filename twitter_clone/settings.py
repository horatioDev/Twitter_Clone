...
SECRET_KEY = 'django-insecure-1inr4wa7%sehayl8f0^h^8&t^o*d@c=+)6#!w%9d88ibpr8ye)'
...
CSRF_TRUSTED_ORIGINS = [
  'http://0.0.0.0:3000/', 'https://twitterclone.ray-xavier-2021.repl.co/',
  'https://twitterclone.ray-xavier-2021.repl.co'
]
...
cloudinary.config(
  ...
  api_key="384369857842777",
  api_secret="nDls6T3CGiUMGMqILerY-enaFOU",
)
